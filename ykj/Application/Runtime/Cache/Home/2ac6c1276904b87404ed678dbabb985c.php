...
<div class="meta">
	...
	<p class="meta-info">发表：<a href="/ykj/index.php"><?php echo ($catename); ?></a> &nbsp;&nbsp; 发表日期：<?php echo (date("Y-m-d",$arts["time"])); ?> &nbsp;&nbsp; </p>
</div>

<!-- 广告代码2 -->

<div class="entry">
	<p><img class="aligncenter size-full wp-image-42806" src="/ykj<?php echo ($arts["pic"]); ?>" width="630" height="399" sizes="(max-width: 630px) 100vw, 630px" /></p>
...
<a class="prev-post icon-right" href="/ykj/index.php/Home/Article/index/id/<?php echo ($prevs["id"]); ?>">
...
<a class="next-post" href="/ykj/index.php/Home/Article/index/id/<?php echo ($nexts["id"]); ?>">
...
<div class="sidebar">
	...
	<ul>
	<?php if(is_array($cateres)): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="cat-item cat-item-18"><a href="/ykj/index.php/Home/Cate/index/id/<?php echo ($vo["id"]); ?>" ><?php echo ($vo["catename"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
	</ul>
</div>
